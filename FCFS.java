    ...
    private static void printCloudletList(List<Cloudlet> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (cloudlet.getCloudletStatus() == Cloudlet.SUCCESS) {
                ...
                sumResponseTime+=cloudlet.getActualCPUTime();
                sumWaitingTime+=cloudlet.getExecStartTime();
        ...
        Log.printLine("Average Waiting Time: " + (sumResponseTime/30));
        Log.printLine("Average Response Time: " +(sumWaitingTime/30));
    }
